...
public class CreateSerieRequestValidator : AbstractValidator<CreateSerieRequest>
{
    public CreateSerieRequestValidator(ILocalizationService localizationService)
    {
        RuleFor(r => r.Title)
            .NotEmpty()
